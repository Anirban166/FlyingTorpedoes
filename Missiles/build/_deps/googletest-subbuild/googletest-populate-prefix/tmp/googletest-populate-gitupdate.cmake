...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "v1.12.1"
  WORKING_DIRECTORY "/Users/anirban166/FlyingTorpedoes/Missiles/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/anirban166/FlyingTorpedoes/Missiles/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/anirban166/FlyingTorpedoes/Missiles/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
